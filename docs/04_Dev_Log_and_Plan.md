...
*   **스탯 및 시스템 개편 (Charm & Social)**:
    *   **Sense -> Charm (매력)**: 사회적 상호작용 및 승진의 핵심 스탯으로 변경.
    *   **평판(Reputation) 삭제**: 매력(Charm) 스탯으로 통합하여 게임 복잡도 감소.
    *   **Socialize 개선**: 단순 스탯 상승 외에 랜덤 이벤트(주식 정보, 프로젝트 등) 추가.
